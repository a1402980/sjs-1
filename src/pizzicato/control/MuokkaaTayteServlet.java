...
public class MuokkaaTayteServlet extends HttpServlet {
	...
	/**
	 * MuokkaaTayteServletin doGet metodi hakee muokattavan täytteenn tiedot
	 * tietokannasta TayteDAOn metodilla, asettaa täytteetlistan attribuutiksi ja ohjaa jsphen
	 **/
	...
	/**
	 * MuokkaaTayteServletin doPost metodi hakee käyttäjän syöttämät tiedot
	 * selaimelta, valdoi ne ja lähettää muokatut tiedot TäyteDAOon.
	 * Ohjaa selaimen listaatäytteet servletiin
	 **/
