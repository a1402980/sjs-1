		...
		<div class="row text-center for-full-back color-light ">
			<div class="col-md-8 col-md-offset-2">
				...
				<form method="post">
					...
					Nimi:<br> <input type="text" name="nimi" placeholder="Kirjoita täytteen nimi tähän" pattern="[a-zA-Z0-9]+[a-zA-Z0-9 ]+" oninvalid="setCustomValidity('Nimessä pitää olla kirjaimia tai numeroita ja pituus vähintään 2 merkkiä.')" oninput="setCustomValidity('')" required ><br> <br>
					Hinta:<br> <input type="decimal" name="hinta" placeholder="X,XX Hinta ei yli 20€" pattern="[0-9,.]{4,2}" oninvalid="setCustomValidity('Hinnan pitää olla numeroina ja muodossa x,xx')" oninput="setCustomValidity('')" required><br> <br>
